...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-3 mt-md-3">
            <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
